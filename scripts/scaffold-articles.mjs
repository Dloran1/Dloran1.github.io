...
<head>
  ...
  <meta property="og:image" content="${DOMAIN}${meta.hero}">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="${meta.title}">
  <meta name="twitter:description" content="${meta.desc}">
  <meta name="twitter:image" content="${DOMAIN}${meta.hero}">
...
<body>
  <div class="wrap">
    <article class="article">
      <h1>${meta.title}</h1>
      <figure class="hero"><img src="${meta.hero}" width="1200" height="628" alt=""></figure>
